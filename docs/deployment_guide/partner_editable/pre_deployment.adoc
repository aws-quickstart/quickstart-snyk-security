...
:xrefstyle: short
Log in to your https://app.snyk.io/login?utm_campaign=Snyk-Security-QS&utm_medium=Partner&utm_source=AWS[Snyk account^] and obtain your organization ID, as shown in <<settings1>> below.
[#settings1]
.Snyk Settings page
