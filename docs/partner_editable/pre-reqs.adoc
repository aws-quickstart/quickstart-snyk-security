...
If you are deploying Snyk Security through an AWS Control Tower-managed multiaccount environment (landing zone), obtain an API authentication token. This token is used to automate the creation of ECR integrations within Snyk.
