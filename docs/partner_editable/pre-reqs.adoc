...
If you are deploying Snyk Security via the automated configuration option for Amazon ECR, obtain an API authentication token. This token is used to automate the creation of organizations and ECR integrations within Snyk.
