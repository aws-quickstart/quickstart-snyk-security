...
To purchase Standard or Pro plans through the AWS Marketplace, proceed with the following steps:

. Sign in to your AWS account.
. {marketplace_listing_url}[Open the page for the {partner-product-short-name} Developer-First Security in AWS Marketplace], and then choose *Continue to Subscribe*.
...
[cols=2*]
|===
^|http://qs_launch_permalink[Deploy {partner-product-short-name} Security full integration on AWS^]
^|http://qs_template_permalink[View template^]

^|http://qs_launch_permalink[Deploy {partner-product-short-name} Security with Amazon Elastic Container Registry^]
^|http://qs_template_permalink[View template^]

^|http://qs_launch_permalink[Deploy {partner-product-short-name} Security with AWS Lambda^]
^|http://qs_template_permalink[View template^]
|===
